...
@property(strong) HBReachability * googleReach;
@property(strong) HBReachability * localWiFiReach;
@property(strong) HBReachability * internetConnectionReach;
...
- (void)viewDidLoad
{
    ...
    self.googleReach = [HBReachability reachabilityWithHostname:@"www.google.com"];
    
    self.googleReach.reachableBlock = ^(HBReachability * reachability)
    {
    ...
    self.googleReach.unreachableBlock = ^(HBReachability * reachability)
    {
    ...
    self.localWiFiReach = [HBReachability reachabilityForLocalWiFi];

    // we ONLY want to be reachable on WIFI - cellular is NOT an acceptable connectivity
    self.localWiFiReach.reachableOnWWAN = NO;

    self.localWiFiReach.reachableBlock = ^(HBReachability * reachability)
    {
    ...
    self.localWiFiReach.unreachableBlock = ^(HBReachability * reachability)
    {
    ...
    self.internetConnectionReach = [HBReachability reachabilityForInternetConnection];

    self.internetConnectionReach.reachableBlock = ^(HBReachability * reachability)
    {
    ...
    self.internetConnectionReach.unreachableBlock = ^(HBReachability * reachability)
    {
...
-(void)reachabilityChanged:(NSNotification*)note
{
    HBReachability * reach = [note object];
